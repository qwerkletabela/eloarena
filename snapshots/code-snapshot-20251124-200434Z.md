# Code snapshot (2025-11-24T20:04:33Z)

## Git

```
commit 80232b5501e8ff4b23c0f2de5b4575612fef7fba
Author:     MichaÅ‚ <qwerkle.tabela@gmail.com>
AuthorDate: Mon Nov 24 21:04:15 2025 +0100
Commit:     MichaÅ‚ <qwerkle.tabela@gmail.com>
CommitDate: Mon Nov 24 21:04:15 2025 +0100

    Dodano obsÅ‚ugÄ™ miejsc turniejÃ³w:
    - nowy panel admin /admin/miejsca
    - formularz dodawania i edycji miejsc (MiejsceForm)
    - integracja z MapPicker (wybÃ³r wspÃ³Å‚rzÄ™dnych)
    - poprawki w MapPicker
    - aktualizacja stron panelu turniejÃ³w pod nowe pola
```
...
```
total 328
drwxr-xr-x 9 runner runner   4096 Nov 24 20:04 .
drwxr-xr-x 3 runner runner   4096 Nov 24 20:04 ..
drwxr-xr-x 7 runner runner   4096 Nov 24 20:04 .git
drwxr-xr-x 3 runner runner   4096 Nov 24 20:04 .github
-rw-r--r-- 1 runner runner    480 Nov 24 20:04 .gitignore
-rw-r--r-- 1 runner runner   1450 Nov 24 20:04 README.md
drwxr-xr-x 8 runner runner   4096 Nov 24 20:04 app
-rw-r--r-- 1 runner runner    572 Nov 24 20:04 code-snapshot.md
drwxr-xr-x 2 runner runner   4096 Nov 24 20:04 components
-rw-r--r-- 1 runner runner  11194 Nov 24 20:04 db.txt
-rw-r--r-- 1 runner runner    465 Nov 24 20:04 eslint.config.mjs
drwxr-xr-x 3 runner runner   4096 Nov 24 20:04 lib
-rw-r--r-- 1 runner runner    156 Nov 24 20:04 next.config.ts
-rw-r--r-- 1 runner runner 249796 Nov 24 20:04 package-lock.json
-rw-r--r-- 1 runner runner    746 Nov 24 20:04 package.json
-rw-r--r-- 1 runner runner     82 Nov 24 20:04 postcss.config.js
drwxr-xr-x 2 runner runner   4096 Nov 24 20:04 public
drwxr-xr-x 2 runner runner   4096 Nov 24 20:04 snapshots
-rw-r--r-- 1 runner runner    246 Nov 24 20:04 tailwind.config.js
-rw-r--r-- 1 runner runner    666 Nov 24 20:04 tsconfig.json
...
export default function MiejsceForm({ mode, initial }: Props) {
  ...
  const [coordinatesInput, setCoordinatesInput] = useState('') // DODANE: stan dla pola wspÃ³Å‚rzÄ™dnych

  const [saving, setSaving] = useState(false)
  const [error, setError] = useState<string | null>(null)
  const [success, setSuccess] = useState(false)

  // Funkcja do aktualizacji wspÃ³Å‚rzÄ™dnych z MapPicker
  const handleLocationChange = (lat: number, lng: number) => {
    setLatitude(lat)
    setLongitude(lng)
  }

  // DODANE: Funkcja do parsowania wklejonych wspÃ³Å‚rzÄ™dnych
  ...
  function resetForm() {
    ...
    setLatitude(52.0)
    setLongitude(19.0)
    setCoordinatesInput('') // DODANE: wyczyÅ›Ä‡ teÅ¼ pole wspÃ³Å‚rzÄ™dnych
    setError(null)
    setSuccess(false)
  }
      ...
      <div className="rounded-xl border border-slate-700 bg-slate-900/40 p-4 space-y-4">
        <div className="flex items-center justify-between gap-2">
          ...
          <span className="text-xs text-slate-400">
            kliknij na mapie albo popraw rÄ™cznie
          </span>
        </div>

        {/* DODANE: Pole do wklejania wspÃ³Å‚rzÄ™dnych */}
        <div className="space-y-2">
        ...
        {/* MapPicker â€“ klikanie ustawia latitude/longitude */}
        ...
        {/* Inputs liczbowy jako podglÄ…d / rÄ™czna korekta */}
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-1">
            <label className="text-xs font-medium text-slate-300">
        ...
        <p className="text-xs text-slate-400">
          KlikniÄ™cie na mapie przeniesie pinezkÄ™ i zaktualizuje pola ze wspÃ³Å‚rzÄ™dnymi.
        </p>
      </div>

# Code snapshot (2025-11-13T14:04:35Z)

## Git

```
commit cc3f89309545674848c4df5b521fb1635d7d3d56
Author:     MichaÅ‚ <qwerkle.tabela@gmail.com>
AuthorDate: Thu Nov 13 15:04:25 2025 +0100
Commit:     MichaÅ‚ <qwerkle.tabela@gmail.com>
CommitDate: Thu Nov 13 15:04:25 2025 +0100
...
```
total 324
drwxr-xr-x 9 runner runner   4096 Nov 13 14:04 .
drwxr-xr-x 3 runner runner   4096 Nov 13 14:04 ..
drwxr-xr-x 7 runner runner   4096 Nov 13 14:04 .git
drwxr-xr-x 3 runner runner   4096 Nov 13 14:04 .github
-rw-r--r-- 1 runner runner    480 Nov 13 14:04 .gitignore
-rw-r--r-- 1 runner runner   1450 Nov 13 14:04 README.md
drwxr-xr-x 8 runner runner   4096 Nov 13 14:04 app
-rw-r--r-- 1 runner runner    368 Nov 13 14:04 code-snapshot.md
drwxr-xr-x 2 runner runner   4096 Nov 13 14:04 components
-rw-r--r-- 1 runner runner   7652 Nov 13 14:04 db.txt
-rw-r--r-- 1 runner runner    465 Nov 13 14:04 eslint.config.mjs
drwxr-xr-x 3 runner runner   4096 Nov 13 14:04 lib
-rw-r--r-- 1 runner runner    156 Nov 13 14:04 next.config.ts
-rw-r--r-- 1 runner runner 249796 Nov 13 14:04 package-lock.json
-rw-r--r-- 1 runner runner    746 Nov 13 14:04 package.json
-rw-r--r-- 1 runner runner     82 Nov 13 14:04 postcss.config.js
drwxr-xr-x 2 runner runner   4096 Nov 13 14:04 public
drwxr-xr-x 2 runner runner   4096 Nov 13 14:04 snapshots
-rw-r--r-- 1 runner runner    246 Nov 13 14:04 tailwind.config.js
-rw-r--r-- 1 runner runner    666 Nov 13 14:04 tsconfig.json
...
export default async function EditTurniejPage({ params, searchParams }: { params: Params, searchParams: SearchParams }) {
  ...
  return (
    <main className="mx-auto max-w-2xl p-6 space-y-6">
      ...
      {err && 
      <AutoHide><div className="rounded-md border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-700">Nie udaÅ‚o siÄ™ zapisaÄ‡.</div>
      </AutoHide>}

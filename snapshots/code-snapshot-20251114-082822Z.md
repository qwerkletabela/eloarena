# Code snapshot (2025-11-14T08:28:21Z)

## Git

```
commit 7e304a64a8ebcdb641477010f4b57ad35724be17
Author:     MichaÅ‚ <qwerkle.tabela@gmail.com>
AuthorDate: Fri Nov 14 09:28:01 2025 +0100
Commit:     MichaÅ‚ <qwerkle.tabela@gmail.com>
CommitDate: Fri Nov 14 09:28:01 2025 +0100

    fix(admin): poprawna normalizacja PL (Å‚/Ã³/Å›...) w podglÄ…dzie arkusza â€“ zgodna z SQL public.norm_txt
```
...
```
total 328
drwxr-xr-x 9 runner runner   4096 Nov 14 08:28 .
drwxr-xr-x 3 runner runner   4096 Nov 14 08:28 ..
drwxr-xr-x 7 runner runner   4096 Nov 14 08:28 .git
drwxr-xr-x 3 runner runner   4096 Nov 14 08:28 .github
-rw-r--r-- 1 runner runner    480 Nov 14 08:28 .gitignore
-rw-r--r-- 1 runner runner   1450 Nov 14 08:28 README.md
drwxr-xr-x 8 runner runner   4096 Nov 14 08:28 app
-rw-r--r-- 1 runner runner    409 Nov 14 08:28 code-snapshot.md
drwxr-xr-x 2 runner runner   4096 Nov 14 08:28 components
-rw-r--r-- 1 runner runner  11194 Nov 14 08:28 db.txt
-rw-r--r-- 1 runner runner    465 Nov 14 08:28 eslint.config.mjs
drwxr-xr-x 3 runner runner   4096 Nov 14 08:28 lib
-rw-r--r-- 1 runner runner    156 Nov 14 08:28 next.config.ts
-rw-r--r-- 1 runner runner 249796 Nov 14 08:28 package-lock.json
-rw-r--r-- 1 runner runner    746 Nov 14 08:28 package.json
-rw-r--r-- 1 runner runner     82 Nov 14 08:28 postcss.config.js
drwxr-xr-x 2 runner runner   4096 Nov 14 08:28 public
drwxr-xr-x 2 runner runner   4096 Nov 14 08:28 snapshots
-rw-r--r-- 1 runner runner    246 Nov 14 08:28 tailwind.config.js
-rw-r--r-- 1 runner runner    666 Nov 14 08:28 tsconfig.json
...
/** Heurystyka separatora + prosty parser CSV (obsÅ‚uga "cudzysÅ‚owÃ³w") */
...
/** Twarde odogonkowienie polskich znakÃ³w (Å‚â†’l itd.) */
...
function normTxt(s: string) {
  return unaccentPl(s)
    .toLowerCase()
    .normalize('NFD')              // rozbij resztÄ™ akcentÃ³w (np. Ã©)
    .replace(/[\u0300-\u036f]/g, '') // usuÅ„ znaki Å‚Ä…czÄ…ce (diakrytyki)
    .replace(/\s+/g, ' ')
    .trim()
}

/** Rozbicie "ImiÄ™ Nazwisko" â†’ { imie, nazwisko } (ostatnie sÅ‚owo = nazwisko) */
...
export default async function EditTurniejPage({ params, searchParams }: { params: Params, searchParams: SearchParams }) {
  ...
  // (opcjonalnie) lista istniejÄ…cych uczestnikÃ³w (v_wyniki)
  ...
  // ---- PODGLÄ„D Z ARKUSZA (ta sama strona) ----
                    ...
                    return (
                      <tr key={`${n.raw}-${i}`} className="border-b last:border-0">
                        ...
                        <td className="px-3 py-2">
                          {exists ? <span className="text-green-700">âœ… w bazie</span> : <span className="text-slate-700">â€” brak â€”</span>}
                        </td>
                        <td className="px-3 py-2">
                          {!exists && (
                            <form action="/admin/gracz/add" method="post" className="inline">
                              ...
                              {/* wracamy na bieÅ¼Ä…cÄ… stronÄ™ po akcji */}
                  ...
                  {!previewNames.length && (
                    <tr>
                      <td className="px-3 py-6 text-sm opacity-60" colSpan={4}>
                        Brak danych do podglÄ…du â€” uzupeÅ‚nij link, kolumnÄ™ i pierwszy wiersz.
                      </td>
                    </tr>
                  )}
                </tbody>

# Code snapshot (2025-11-21T13:12:50Z)

## Git

```
commit 396dafb39f635fd5aa9b6909e3331591ada5c886
Author:     MichaÅ‚ <qwerkle.tabela@gmail.com>
AuthorDate: Fri Nov 21 14:12:39 2025 +0100
Commit:     MichaÅ‚ <qwerkle.tabela@gmail.com>
CommitDate: Fri Nov 21 14:12:39 2025 +0100
...
```
total 328
drwxr-xr-x 9 runner runner   4096 Nov 21 13:12 .
drwxr-xr-x 3 runner runner   4096 Nov 21 13:12 ..
drwxr-xr-x 7 runner runner   4096 Nov 21 13:12 .git
drwxr-xr-x 3 runner runner   4096 Nov 21 13:12 .github
-rw-r--r-- 1 runner runner    480 Nov 21 13:12 .gitignore
-rw-r--r-- 1 runner runner   1450 Nov 21 13:12 README.md
drwxr-xr-x 8 runner runner   4096 Nov 21 13:12 app
-rw-r--r-- 1 runner runner    368 Nov 21 13:12 code-snapshot.md
drwxr-xr-x 2 runner runner   4096 Nov 21 13:12 components
-rw-r--r-- 1 runner runner  11194 Nov 21 13:12 db.txt
-rw-r--r-- 1 runner runner    465 Nov 21 13:12 eslint.config.mjs
drwxr-xr-x 3 runner runner   4096 Nov 21 13:12 lib
-rw-r--r-- 1 runner runner    156 Nov 21 13:12 next.config.ts
-rw-r--r-- 1 runner runner 249796 Nov 21 13:12 package-lock.json
-rw-r--r-- 1 runner runner    746 Nov 21 13:12 package.json
-rw-r--r-- 1 runner runner     82 Nov 21 13:12 postcss.config.js
drwxr-xr-x 2 runner runner   4096 Nov 21 13:12 public
drwxr-xr-x 2 runner runner   4096 Nov 21 13:12 snapshots
-rw-r--r-- 1 runner runner    246 Nov 21 13:12 tailwind.config.js
-rw-r--r-- 1 runner runner    666 Nov 21 13:12 tsconfig.json
...
export default function Navbar({ user, role }: { user: UserLite; role: Role }) {
  ...
  return (
    <header className="sticky top-0 z-50">
      {/* cienki pasek akcentu na gÃ³rze */}
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-2">
              {/* gdy NIE zalogowany â†’ najpierw Rejestracja, potem Turnieje */}
          ...
          <div className="hidden md:flex items-center gap-4">
            {user ? (
              ...
              <div className="flex flex-col items-end gap-1">
                ...
                {/* tutaj usuniÄ™to link "rejestracja", bo przeniesiony na lewÄ… stronÄ™ */}
              </div>
            )}
          </div>
        ...
        {open && (
          <div className="md:hidden border-t border-sky-800 bg-slate-950/95">
            <div className="flex flex-col gap-2 px-4 py-3">
              {/* taki sam porzÄ…dek jak na desktopie */}
              {!user && <NavLink href="/auth/signup">Rejestracja</NavLink>}
              <NavLink href="/turniej">Turnieje</NavLink>
              {user && <NavLink href="/profile">Profil</NavLink>}
              {role === 'admin' && <NavLink href="/admin">Admin</NavLink>}

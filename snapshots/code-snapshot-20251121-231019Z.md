# Code snapshot (2025-11-21T23:10:18Z)

## Git

```
commit 595036ad3db2baab447db7924feb7e39388cd471
Author:     MichaÅ‚ <qwerkle.tabela@gmail.com>
AuthorDate: Sat Nov 22 00:10:07 2025 +0100
Commit:     MichaÅ‚ <qwerkle.tabela@gmail.com>
CommitDate: Sat Nov 22 00:10:07 2025 +0100
...
```
total 328
drwxr-xr-x 9 runner runner   4096 Nov 21 23:10 .
drwxr-xr-x 3 runner runner   4096 Nov 21 23:10 ..
drwxr-xr-x 7 runner runner   4096 Nov 21 23:10 .git
drwxr-xr-x 3 runner runner   4096 Nov 21 23:10 .github
-rw-r--r-- 1 runner runner    480 Nov 21 23:10 .gitignore
-rw-r--r-- 1 runner runner   1450 Nov 21 23:10 README.md
drwxr-xr-x 8 runner runner   4096 Nov 21 23:10 app
-rw-r--r-- 1 runner runner    368 Nov 21 23:10 code-snapshot.md
drwxr-xr-x 2 runner runner   4096 Nov 21 23:10 components
-rw-r--r-- 1 runner runner  11194 Nov 21 23:10 db.txt
-rw-r--r-- 1 runner runner    465 Nov 21 23:10 eslint.config.mjs
drwxr-xr-x 3 runner runner   4096 Nov 21 23:10 lib
-rw-r--r-- 1 runner runner    156 Nov 21 23:10 next.config.ts
-rw-r--r-- 1 runner runner 249796 Nov 21 23:10 package-lock.json
-rw-r--r-- 1 runner runner    746 Nov 21 23:10 package.json
-rw-r--r-- 1 runner runner     82 Nov 21 23:10 postcss.config.js
drwxr-xr-x 2 runner runner   4096 Nov 21 23:10 public
drwxr-xr-x 2 runner runner   4096 Nov 21 23:10 snapshots
-rw-r--r-- 1 runner runner    246 Nov 21 23:10 tailwind.config.js
-rw-r--r-- 1 runner runner    666 Nov 21 23:10 tsconfig.json
...
function createGoogleCalendarUrl(r: Row): string | null {
  ...
  // ZakÅ‚adamy, Å¼e turniej trwa 3 godziny
...
export default function MapPicker({
  ...
  // Czekamy aÅ¼ google.maps bÄ™dzie dostÄ™pne (polling do 5s)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    // Poczekaj aÅ¼ modal wyrenderuje wymiary
          ...
          <div className="w-full max-w-3xl overflow-hidden rounded-lg bg-white shadow-lg">
            ...
            {failed && (
              <div className="flex h-[60vh] w-full flex-col items-center justify-center gap-2 p-4 text-center text-sm text-red-700">
                Nie udaÅ‚o siÄ™ zaÅ‚adowaÄ‡ mapy. SprawdÅº klucz/referrer i wtyczki blokujÄ…ce.
                <button
                  type="button"

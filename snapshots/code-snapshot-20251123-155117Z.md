# Code snapshot (2025-11-23T15:51:16Z)

## Git

```
commit ad65f7d2a2cbe52e29b075d18a2824a2b28e46e6
Author:     MichaÅ‚ <qwerkle.tabela@gmail.com>
AuthorDate: Sun Nov 23 16:50:47 2025 +0100
Commit:     MichaÅ‚ <qwerkle.tabela@gmail.com>
CommitDate: Sun Nov 23 16:50:47 2025 +0100

    UI dark brand + rola organizer i poprawki panelu admina
```
...
```
total 328
drwxr-xr-x 9 runner runner   4096 Nov 23 15:51 .
drwxr-xr-x 3 runner runner   4096 Nov 23 15:51 ..
drwxr-xr-x 7 runner runner   4096 Nov 23 15:51 .git
drwxr-xr-x 3 runner runner   4096 Nov 23 15:51 .github
-rw-r--r-- 1 runner runner    480 Nov 23 15:51 .gitignore
-rw-r--r-- 1 runner runner   1450 Nov 23 15:51 README.md
drwxr-xr-x 8 runner runner   4096 Nov 23 15:51 app
-rw-r--r-- 1 runner runner    359 Nov 23 15:51 code-snapshot.md
drwxr-xr-x 2 runner runner   4096 Nov 23 15:51 components
-rw-r--r-- 1 runner runner  11194 Nov 23 15:51 db.txt
-rw-r--r-- 1 runner runner    465 Nov 23 15:51 eslint.config.mjs
drwxr-xr-x 3 runner runner   4096 Nov 23 15:51 lib
-rw-r--r-- 1 runner runner    156 Nov 23 15:51 next.config.ts
-rw-r--r-- 1 runner runner 249796 Nov 23 15:51 package-lock.json
-rw-r--r-- 1 runner runner    746 Nov 23 15:51 package.json
-rw-r--r-- 1 runner runner     82 Nov 23 15:51 postcss.config.js
drwxr-xr-x 2 runner runner   4096 Nov 23 15:51 public
drwxr-xr-x 2 runner runner   4096 Nov 23 15:51 snapshots
-rw-r--r-- 1 runner runner    246 Nov 23 15:51 tailwind.config.js
-rw-r--r-- 1 runner runner    666 Nov 23 15:51 tsconfig.json
        ...
        <div className="w-full max-w-4xl rounded-2xl bg-slate-800/95 border border-slate-700 shadow-[0_14px_40px_rgba(0,0,0,0.8)] p-6 space-y-6">
          ...
          <section className="grid gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-xs text-slate-300">
                PrzeglÄ…d i zarzÄ…dzanie tabelÄ… gracz, import z turniejÃ³w.
              </p>
            </Link>
          </section>
        </div>
...
export default async function EditTurniejPage({ params, searchParams }: { params: Params, searchParams: SearchParams }) {
  ...
  if (t.gsheet_url && t.kolumna_nazwisk && t.pierwszy_wiersz_z_nazwiskiem) {
    try {
      ...
      // Pobierz zakres komÃ³rek (np. G4:G100) zamiast caÅ‚ego arkusza
      ...
      const colIdx = 0 // poniewaÅ¼ pobraliÅ›my tylko jednÄ… kolumnÄ™, to zawsze 0

      // PrzeksztaÅ‚Ä‡ dane na listÄ™ z poprawnÄ… numeracjÄ… wierszy
      ...
      <div className="w-full max-w-6xl rounded-2xl bg-slate-800/95 border border-slate-700 shadow-[0_14px_40px_rgba(0,0,0,0.8)] p-6 space-y-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-400">ZarzÄ…dzanie danymi turnieju i uczestnikami</p>
          </div>
        ...
        <form action={`/admin/turniej/${t.id}/update`} method="post" className="space-y-6">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div>
                  <label className={labelClass}>SzerokoÅ›Ä‡ (lat)</label>
                  <input 
                    id="lat" 
                    name="lat" 
                    defaultValue={t.lat ?? ''} 
                ...
                <div>
                  <label className={labelClass}>DÅ‚ugoÅ›Ä‡ (lng)</label>
                  <input 
                    id="lng" 
                    name="lng" 
                    defaultValue={t.lng ?? ''} 
              ...
              {/* WybÃ³r karty z pliku */}
              <div>
                <label className={labelClass}>Wybierz kartÄ™ z pliku</label>
                <div className="mt-1">
                  <SheetPicker
